                ...
                <div class="row">
                    <div class="col-12 col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            // Assuming you have Block model and you are fetching the data like this
                            ...
                            {{ html()->select($field_name, $blocks)->class('form-control')->attributes([$required]) }}
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            // Assuming you have Flat model and you are fetching the data like this
                            $flats = \Modules\Flat\Models\Flat::pluck('name', 'id')->prepend('Please select', '');
                            ?>
                            {{ html()->label($field_label, $field_name)->class('form-label') }} {!! field_required($required) !!}
                            {{ html()->select($field_name, $flats)->class('form-control')->attributes([$required]) }}
                        </div>
                    </div>
                </div>
