                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("emergencycontact::text.name")
                            </th>
                            <th>
                                @lang("emergencycontact::text.slug")
                            </th>
                            <th>
                                @lang("emergencycontact::text.updated_at")
                            </th>
                            <th>
                                @lang("emergencycontact::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("emergencycontact::text.action")
                            </th>
                        </tr>
                    </thead>
