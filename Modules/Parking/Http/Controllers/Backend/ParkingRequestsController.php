...
class ParkingRequestsController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Parking Requests';

        // module name
        $this->module_name = 'parkings';

        $this->module_name_sub = 'parking_requests';
        ...
        $this->module_model = "Modules\Parking\Models\ParkingRequest";
    }
    ...
    public function index()
    {
        ...
        $module_name_sub = $this->module_name_sub;
        ...
        return view(
            "{$module_path}.{$module_name}.requests.index_datatable",
            compact('module_title', 'module_name', "{$module_name}","module_name_sub", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
    ...
    public function create()
    {
        ...
        return view(
            "{$module_path}.{$module_name}.requests.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "{$module_path}.{$module_name}.requests.show",
    ...
    public function trashed()
    {
        ...
        return view(
            "{$module_path}.{$module_name}.requests.trash",
