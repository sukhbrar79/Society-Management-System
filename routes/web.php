...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    */
    ...
    Route::get("{$module_name}/residents_data", ['as' => "{$module_name}.residents_data", 'uses' => "{$controller_name}@residents_data"]);
    Route::get("/residents", ['as' => "{$module_name}.residents", 'uses' => "{$controller_name}@residents"]);
